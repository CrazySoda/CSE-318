...
def main():
    ...
    while True:
        ...
        print("4. Generate Heuristic Comparison Analysis")
        ...
        if choice == "0":
            ...
            if analyzer.task4_data is None and analyzer.task5_data is None:
                print("Loading results first...")
                if not analyzer.load_latest_results():
                    continue
            ...
            if analyzer.load_latest_results():
                if analyzer.task4_data is not None:
                    analyzer.generate_task4_analysis()
                if analyzer.task5_data is not None:
                    analyzer.generate_task5_analysis()
